...
- Android 实机：核心查询界面已验收；
- 本地 Chromium：19 组回归通过；
...
- 提供手机友好的页面显示设置入口；
- 独立控制 iWeb、COCA、Spoken 与 Phrase Frequency；
- 独立控制考试标签、柯林斯星级与释义占比胶囊；
- 提供简洁查询模式、恢复默认值和偏好保存。

下一版本只控制 0.1.0 已稳定模块的显隐，不重新设计词频数据结构。
